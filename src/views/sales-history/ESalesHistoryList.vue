...
const loadData = async () => {
    try {
        ...
        console.log("searchCriteria.value.salesHistoryDate_end", searchCriteria.value.salesHistoryDate_end);
        ...
        // 쿼리 문자열 생성
        const queryString = `employee/search?${new URLSearchParams(query).toString()}`;
